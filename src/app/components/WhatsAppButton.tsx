...
export default function WhatsAppButton() {
  const phoneNumber = '916238392582';
  const message = encodeURIComponent("Hello! I'd like to inquire about your motorcycle services.");
  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="relative flex items-center justify-center w-14 h-14 bg-[#25D366] hover:bg-[#20ba5a] text-white rounded-full shadow-2xl shadow-[#25D366]/40 hover:scale-110 active:scale-95 transition-all duration-300"
      >
        {/* Pulse effect rings */}
