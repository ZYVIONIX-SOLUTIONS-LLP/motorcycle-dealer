...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 w-full h-[100dvh] z-[999] bg-white flex flex-col justify-between p-6 lg:hidden shadow-2xl overflow-y-auto">
          <div className="flex flex-col gap-3">
            {/* Header with Brand & Close Button */}
            <div className="flex items-center justify-between pb-4 border-b border-gray-100">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-xl bg-red-600 flex items-center justify-center text-white shadow-md shadow-red-600/20">
                  <Bike className="w-5 h-5 stroke-[2.5]" />
                </div>
                <div className="flex flex-col">
                  <span className="font-heading font-black text-lg tracking-tight leading-none text-gray-900">
                    RIDE<span className="text-red-600">HUB</span>
                  </span>
          ...
          {/* Bottom CTAs */}
          <div className="flex flex-col gap-3 pt-6 border-t border-gray-100 mt-6 pb-4">
            <Link
              href="/used-bikes"
              onClick={() => setIsMobileMenuOpen(false)}
